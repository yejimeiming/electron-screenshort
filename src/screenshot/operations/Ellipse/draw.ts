import { type EllipseData, type EllipseEditData, EllipseEditType } from './types'
...
export function draw(ctx: CanvasRenderingContext2D, action: HistoryItemSource<EllipseData, EllipseEditData>) {
